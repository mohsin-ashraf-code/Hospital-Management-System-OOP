...
Patient::Patient(int i, const char* n, const char* p, int a, char g, const char* c, float b)
...
void Patient::addBalance(float amount) { balance += amount; }
void Patient::deductBalance(float amount) { balance -= amount; }
